import EdgePair as e,Parent as p,Union as u,FindBasic as f
import sys
import time
sys.setrecursionlimit(10**6)
def isCycle(edges,parents): 
    for i in edges: 
        p1 = f.findAbsoluteParent(parents,i.v1)
        p2 = f.findAbsoluteParent(parents,i.v2)
        if p1==p2 and p1 != -1 and p2 != -1 :
            return True
        else:
            u.union(parents,i.v1,i.v2)
    return False
def main(): 
